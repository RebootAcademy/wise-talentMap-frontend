<template>
  <div class="
        ...
        md:p-8  md:grid md:grid-cols-8">
    <div class="
        px-4 py-6 col-span-6 flex flex-col justify-center place-items-center gap-4 animate__animated animate__zoomIn
        md:col-span-8
        lg:mb-0 lg:grid lg:grid-cols-12 lg:gap-8">
      <h1 class="
        font-bebas text-3xl text-center text-anthraciteGray mb-4 
        smd:text-4xl
        md:text-5xl
      ...
      <div class="
        ...
        lg:col-span-7
        xl:hidden" @click="() => $router.push('/talentMap')">
      ...
      <div class="lg:col-span-5 lg:flex lg:flex-col lg:gap-8">
        <p class="
          ...
          fácilmente con profesionales clave y acceder a una red de referentes que promueven una comunidad más inclusiva
          y
          diversa.
        </p>
        <CustomButton class="
