<template>
  <div class="flex flex-col  md:gap-0  p-5 md:p-0 justify-center items-center bg-black text-secondary-white md:h-24">
    <div class="flex flex-col gap-6 w-full md:gap-0 md:flex-row p-5 md:p-0 justify-between items-center">

      <div class="flex gap-6 md:pl-11">
        <a href="https://www.linkedin.com/company/wisecanarias/?trk=public_post_main-feed-card_reshare_feed-actor-name"
          target="_blank">
          <Icon icon="linkedin" class="cursor-pointer" color="white" isHovered extraStyles="24px" />
      ...
      <div class="flex gap-6 font-bebas md:text-2xl md:pr-11">
        ...
        <a href="/legal" target="_blank">
          <p class="hover:text-primary-violet">Aviso legal</p>
        </a>
      </div>
    </div>
    <p>www.wisecanarias.com</p>
  </div>
</template>
