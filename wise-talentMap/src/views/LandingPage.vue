<template>
  <div>
    <div class="relative px-12 py-12">
      <SteamMap v-if="showMap" class="w-full  animate__animated animate__slideInLeft " />
      <p class="absolute top-1/2  text-4xl " :class="showMap ? 'left-2 rotate-180' : ' right-2'"
        @click="changeShowMapStatus">></p>
